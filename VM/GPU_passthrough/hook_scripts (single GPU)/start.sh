...
# my vm disk runs here
VM_STORAGE_MNT="/media/$(whoami)/OpsStorage/"
if [ ! -d "$VM_STORAGE_MNT" ]; then
    sudo mkdir -p "$VM_STORAGE_MNT"
    sudo mount -t ntfs-3g /dev/sda8 "$VM_STORAGE_MNT"
fi
